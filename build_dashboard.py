...
def table(name, ds, cols, title, x, y, w, h):
    # cols: list of (fieldName, displayName)
...
page2 = {"name": "page-spill-detail", "displayName": "Spill Detail & Expanded Disk", "pageType": "PAGE_TYPE_CANVAS", "layout": [
    ...
    table("spilld-pressure", "ds-disk-pressure", [
    ...
    table("spilld-events", "ds-expanded-disk", [
...
# (existing right-sizing datasets + global filters also key off p_catalog/p_schema)
...
print("pages:", [p["name"] for p in d["pages"]])
