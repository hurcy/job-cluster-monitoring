...
This folder defines all source code for the 'sdp_optimization' pipeline:
...
* Take a look at the sample under "sample_users_sdp_optimization.sql" to get familiar with the syntax.
